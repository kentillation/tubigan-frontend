            ...
            <v-container v-model="value" color="primary">
                ...
                <v-btn class="item-card">
                    <span class="d-flex align-start flex-column">
                        <h4>Bottled Water</h4>
                        <h5 class="text-grey">500 milliliters</h5>
                        <h2 class="mt-12">50 PHP</h2>
                    </span>
                    <span class="img-container">
                        <img :src="container1" style="width: 50px;" loading="lazy" alt="Container 1" />
